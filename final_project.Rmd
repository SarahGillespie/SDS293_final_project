...
```{r Quinn_and_coffee, fig.cap="Image Description: My white and gray Ragdoll kitty sprawls on a desk next to a black Toasted Coconut Cream cold brew coffee from Shelburne Falls Coffee Roasters. The background is out of focus and has visible office clutter, including yellow pencils, a teal Olivetti Underwood Lettera 32 typewriter, a purple painting, and a printer.", echo=FALSE, out.width="100%", fig.align='center'}
